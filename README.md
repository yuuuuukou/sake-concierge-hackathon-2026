...
flowchart LR
  ...
  frontend -->|"SSE chat stream"| bff["FastAPI BFF"]
  frontend -->|"Store profile and feedback APIs"| bff
  bff --> agent["Microsoft Foundry Agent Service"]
  agent --> tool["Brand research function tool"]
  tool --> research["Brand research agent"]
  bff --> catalog["Masked local CSV or private Blob"]
  bff --> logs["Structured logs and Azure Monitor"]
```
